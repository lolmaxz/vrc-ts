...
export async function userAPITest(vrchat: VRChatAPI) {
    // search User
    const searchUser = await vrchat.userApi.searchAllUsers({ search: 'test', n: 5 });
    ...
    // update User
    const userUpdate = await vrchat.userApi.updateUserInfo({
        userId: 'usr_e98ee7ac-2364-4669-b7ef-02991e40a797',
        email: ' ',
        birthday: '1993-10-07',
    });
    ...
    const userGroupRequests = await vrchat.userApi.getUserGroupRequests({
        userId: 'usr_e98ee7ac-2364-4669-b7ef-02991e40a797',
    });
