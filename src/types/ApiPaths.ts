export const ApiPaths: APIPaths = {
  api: {
    base: {
      path: 'https://api.vrchat.cloud/api/1',
      method: 'GET',
      cookiesNeeded: ['none'],
    },
  },
  ...
  auth: {
    ...
    getCurrentUserInfo: {
      path: '/auth/user',
      method: 'GET',
      cookiesNeeded: ['authCookie', 'authorization', 'twoFactorAuth'],
    },
    verify2FATOTP: {
      path: '/auth/twofactorauth/totp/verify',
      method: 'POST',
      cookiesNeeded: ['authCookie'],
      requiresData: true,
    },
    verify2FAOTP: {
  ...
  fav: {
    ...
    showFavoriteGroup: {
      ...
      method: 'GET',
      cookiesNeeded: ['authCookie'],
      requiredQueryParams: ['userId', 'favoriteGroupType', 'favoriteGroupName'],
    },
    updateFavoriteGroup: {
      path: '/favorite/group/{favoriteGroupType}/{favoriteGroupName}/{userId}',
      method: 'PUT',
  ...
  files: {
    ...
    downloadFileVersion: {
      ...
      cookiesNeeded: ['authCookie'],
      requiresData: true,
      requiredQueryParams: ['fileId', 'versionId'],
    },
    deleteFileVersion: {
      path: '/file/{fileId}/{versionId}',
      method: 'DELETE',
    ...
    finishFileDataUpload: {
      ...
      method: 'PUT',
      cookiesNeeded: ['authCookie'],
      requiredQueryParams: ['fileId', 'versionId', 'fileType'],
    },
    startFileDataUpload: {
  ...
  groups: {
    ...
    unbanGroupMember: {
      ...
      method: 'DELETE',
      cookiesNeeded: ['authCookie'],
      requiredQueryParams: ['groupId', 'userId'],
    },
    createGroupGallery: {
    ...
    getGroupGalleryImages: {
      ...
      method: 'GET',
      cookiesNeeded: ['authCookie'],
      requiredQueryParams: ['groupId', 'groupGalleryId'],
    },
    updateGroupGallery: {
      path: '/groups/{groupId}/galleries/{groupGalleryId}',
      method: 'PUT',
    ...
    deleteGroupGalleryImage: {
      ...
      method: 'DELETE',
      cookiesNeeded: ['authCookie'],
      requiredQueryParams: ['groupId', 'groupGalleryId', 'groupGalleryImageId'],
    },
    getGroupInvitesSent: {
    ...
    addRoletoGroupMember: {
      ...
      method: 'PUT',
      cookiesNeeded: ['authCookie'],
      requiredQueryParams: ['groupId', 'userId', 'groupRoleId'],
    },
    ...
    updateGroupRole: {
      ...
      cookiesNeeded: ['authCookie'],
      requiresData: true,
      requiredQueryParams: ['groupId', 'groupRoleId'],
    },
    deleteGroupRole: {
      path: '/groups/{groupId}/roles/{groupRoleId}',
      method: 'DELETE',
  ...
  invite: {
    ...
    inviteMyselfToInstance: {
      path: '/invite/myself/to/{worldId}:{instanceId}',
      method: 'POST',
      cookiesNeeded: ['authCookie'],
      requiredQueryParams: ['worldId', 'instanceId'],
    },
    requestInvite: {
    ...
    respondInvite: {
      ...
      cookiesNeeded: ['authCookie'],
      requiresData: true,
      requiredQueryParams: ['notificationId'],
    },
    listInviteMessages: {
      path: '/message/{userId}/{messageType}',
      method: 'GET',
      cookiesNeeded: ['authCookie'],
      requiredQueryParams: ['userId', 'messageType'],
    },
    getInviteMessage: {
      path: '/message/{userId}/{messageType}/{slot}',
      method: 'GET',
      cookiesNeeded: ['authCookie'],
      requiredQueryParams: ['userId', 'messageType', 'slot'],
    },
    updateInviteMessage: {
      path: '/message/{userId}/{messageType}/{slot}',
      method: 'PUT',
  ...
  perms: {
    ...
    getPermission: {
      ...
      method: 'GET',
      cookiesNeeded: ['authCookie'],
      requiredQueryParams: ['permissionId'],
    },
  },
  ...
  Playermods: {
    ...
    getPlayerModeration: {
      ...
      method: 'GET',
      cookiesNeeded: ['authCookie'],
      requiredQueryParams: ['playerModerationId'],
    },
