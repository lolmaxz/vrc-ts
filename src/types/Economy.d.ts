declare namespace VRCAPI {
    namespace Economy {
        namespace Models {
            ...
            type transactionWalletInfoStatus = "Trusted";
            ...
            type SteamTransactions = SteamTransaction[];
        ...
        namespace Requests {
            ...
            type GetSteamTransactionRequest = {
                /** The ID of the Steam Transaction */
                transactionId: string;
            }

            type GetLicenseGroupRequest = {
                /** The ID of the License Group */
                licenseGroupId: string;
            }

            type GetProductListingRequest = {
                /** The ID of the Listing */
                listingId: string;
            ...
            type GetOwnTransactionsRequest = {
                type?: VRCAPI.Economy.Models.TransactionType
                order?: VRCAPI.Worlds.Models.SearchOrderOptions,
                sort?: VRCAPI.Worlds.Models.SearchSortingOptions
                metadata?: boolean
                search?: string
                n?: number
                offset?: number                
